...
export const t = {
  ...
  en: {
    ...
    strengths: [
      ...
      { title: 'People first', body: 'Look after the people, and the work shows it on screen.' },
    ],
  ...
  de: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'Ich habe selbst in vielen Bereichen gearbeitet – Produktion, Regie, Kamera, Schnitt, Farbkorrektur und Drehbuch. Deshalb bewege ich mich auf Augenhöhe mit jedem Department: Ich kann führen und mich zugleich darauf einstellen, was ein Team oder eine Kundin gerade braucht.',
  ...
  es: {
    ...
    about: {
      ...
      paragraphs: [
        ...
        'He trabajado en muchos oficios —producción, dirección, fotografía, montaje, color y guion—, así que me siento cómodo con quien tenga enfrente, capaz de guiar y adaptarme a lo que necesita un equipo o un cliente.',
